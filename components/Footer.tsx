          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            <div>
              ...
              <ul className="flex flex-col gap-3">
                ...
                <li>
                  <a
                    href="https://wa.me/201055492879?text=Hello!%20I%20found%20your%20portfolio%20and%20I'd%20like%20to%20get%20in%20touch%20with%20you."
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group inline-flex items-center gap-2 font-sans text-sm text-cream/80 transition-colors hover:text-olive"
                  >
                    <svg className="h-4 w-4 text-olive" viewBox="0 0 24 24" fill="currentColor" strokeWidth="0">
